  ...
  <div class="feed">
      ...
      <div class="post__interact">
		...
		C444.801,187.101,434.001,213.101,414.401,232.701z"
          ...
          <button class="post__btn">
            <svg
              ...
              style="enable-background:new 0 0 469.038 469.038;"
              xml:space="preserve"
            >
              <g>
                <path
		...
		c2.4,4.1,6.9,6.7,11.6,6.7c0.3,0,0.5,0,0.8,0c5.1-0.3,9.5-3.4,11.6-8.1l191.5-441.8C470.123,13.879,469.023,7.979,465.023,4.079z
		 M394.723,54.979l-226.2,224.7l-124.9-70.8L394.723,54.979z M262.223,425.579l-74.5-126.9l227.5-226L262.223,425.579z"
          ...
          <button class="post__btn post__btn_right-position">
            <svg
              fill="#000000"
              class="btn-pic"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <section class="comment-section">
          ...
          <ul class="comments-list">
            ...
            <li class="comments-item">
              ...
              <span class="comment-text">bruh look at that cat face😂😂😂😂😂😂</span>
            </li>
            <li class="comments-item">
          ...
          <section class="comment-section__post">
            <form action class="post-form">
              <input type="text" class="post-form__input" placeholder="Add a comment...">
            </form>
          </section>
        </section>
      </div>
    ...
    <article class="post">
      <header class="post__header">
        ...
        <div class="op__name profile-name">Not PusPus The Doge</div>
        <button type="button" class="post__func-btn">
              <svg
            version="1.1"
            class="op__icon_func-btn"
      ...
      <div class="pic">
        <img class="post__pic" src="https://uploads.codesandbox.io/uploads/user/75ba45e0-e867-40f0-9a88-d1e779d6e534/nbnL-cat_plate.jpg" alt="post">
      </div>
      <div class="post__interact">
        <div class="post__btns">
          <button class="post__btn">
        ...
        <section class="comment-section">
          <span class="like-number">38,000 likes</span>
          <ul class="comments-list">
            <li class="comments-item">
              <a href class="comment-name">Sebek</a>
              <span class="comment-text">dude</span>
            </li>
            <li class="comments-item">
              <a href class="comment-name">NeSebek</a>
              <span class="comment-text">bruh look at that cat face😂😂😂😂😂😂</span>
            ...
            <li class="comments-item">
              <a href class="comment-name">TochnoNeSebek</a>
              <span class="comment-text">salat top👌</span>
            </li>
          </ul>
          <section class="comment-section__post">
            <form action class="post-form">
